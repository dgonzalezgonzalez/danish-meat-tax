# Policy Summary: Denmark Livestock Carbon Tax Announcement

## Main Event Date

The main event date for this project is 2024-06-24, when the Danish government and Green Tripartite parties announced the agreement on a green Denmark. BBC coverage described the agreement as a world-first carbon tax on livestock emissions.

This project studies announcement effects on supermarket consumer prices. It does not estimate realized effects of a tax already collected at retail checkout.

## Institutional Design

The policy is an agricultural greenhouse-gas tax, not a retail meat excise tax. The announcement concerns emissions from livestock production and broader land-use changes. Public communication focused on cattle and pigs because those are central Danish livestock categories and large emissions sources. Technical and institutional material covers livestock emissions more broadly, so lamb, sheep, and goat products are coded as livestock-exposed rather than clean controls.
