...
GROUP_RULES: tuple[tuple[str, bool, str, str, str, tuple[str, ...]], ...] = (
    ...
    ("poultry", True, "poultry", "livestock_scope", "treated_livestock_meat", ("chicken", "kylling", "hoene", "turkey", "kalkun", "duck", "andebryst")),
    ...
    ("eggs", True, "poultry_eggs", "livestock_scope", "treated_livestock_eggs", ("egg", "eggs", "aeg")),
